...
namespace ApiCatalogo.Migrations
{
    ...
    [Migration("20250714174238_AtualizarTable")]
    partial class AtualizarTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiCatalogo.Models.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProdutoId = 1,
                            CategoriaId = 1,
                            DataCadastro = new DateTime(2025, 7, 14, 14, 42, 38, 219, DateTimeKind.Local).AddTicks(8272),
                        ...
                        new
                        {
                            ProdutoId = 2,
                            CategoriaId = 2,
                            DataCadastro = new DateTime(2025, 7, 14, 14, 42, 38, 219, DateTimeKind.Local).AddTicks(8275),
                        ...
                        new
                        {
                            ProdutoId = 3,
                            CategoriaId = 3,
                            DataCadastro = new DateTime(2025, 7, 14, 14, 42, 38, 219, DateTimeKind.Local).AddTicks(8277),
